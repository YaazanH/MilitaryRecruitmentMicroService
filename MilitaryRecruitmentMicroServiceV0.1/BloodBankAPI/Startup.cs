...
namespace BloodBankAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BloodBankAPI", Version = "v1" });
            });
            ...
            services.AddDbContext<BloodBankContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("BloodBankContext")));


        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, BloodBankContext db)
        {
            db.Database.Migrate();

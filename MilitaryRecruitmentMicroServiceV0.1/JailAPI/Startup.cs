...
namespace JailAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "JailAPI", Version = "v1" });
            });
            ...
            services.AddDbContext<JailContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("JailContext")));
        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, JailContext db)
        {
            db.Database.Migrate();
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "JailAPI v1"));
            }

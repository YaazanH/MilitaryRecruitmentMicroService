...
namespace Blood_BankAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Blood_BankAPI", Version = "v1" });
            });
            ...
            services.AddDbContext<Blood_BankContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("Blood_BankContext")));
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Blood_BankAPI v1"));
            }

...
namespace LaborMinAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "LaborMinAPI", Version = "v1" });
            });
            ...
            services.AddDbContext<LaborMinContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("LaborMinContext")));
        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, LaborMinContext db)
        {
            db.Database.Migrate();
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "LaborMinAPI v1"));
            }

...
namespace HighEduMinAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "HighEduMinAPI", Version = "v1" });
            });
            ...
            services.AddDbContext<HighEduMinContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("HighEduMinContext")));
        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, HighEduMinContext db)
        {
            db.Database.Migrate();
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "HighEduMinAPI v1"));
            }

...
namespace CivilPoliceAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CivilPoliceAPI", Version = "v1" });
            });
            ...
            services.AddDbContext<CivilPoliceContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("CivilPoliceContext")));
        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, CivilPoliceContext db)
        {
            db.Database.Migrate();
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CivilPoliceAPI v1"));
            }

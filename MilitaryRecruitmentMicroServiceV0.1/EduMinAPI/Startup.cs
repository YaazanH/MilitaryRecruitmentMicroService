...
namespace EduMinAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "EduMinAPI", Version = "v1" });
            });
            ...
            services.AddDbContext<EduMinContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("EduMinContext")));
        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, EduMinContext db)
        {
            db.Database.Migrate();
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "EduMinAPI v1"));
            }
